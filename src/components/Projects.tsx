...
export default function Projects() {
  return (
    <section id="projects" className="px-6 md:px-12 lg:pl-36 xl:pl-48 py-20 md:py-28">
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {project.private && (
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-white/[0.05] border border-white/[0.1] text-muted">
                      Private / NDA
                    </span>
                  )}
                </div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.stack.split(" · ").map((tech) => (
                  <span
                    key={tech}
                    className="text-[11px] font-mono text-muted px-2 py-0.5 rounded-md bg-white/[0.04] border border-white/[0.06]"
                  >
                    {tech}
                  </span>
                ))}
