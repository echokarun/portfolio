        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-muted hover:text-foreground transition-colors ml-1 p-1"
              ...
              <div className="flex flex-col px-6 py-4 gap-1">
                {sections.map((s, i) => (
                  <motion.button
                    ...
                    className="text-left text-sm text-muted hover:text-foreground transition-colors py-3 w-full"
                  >
                    {s.label}
                  </motion.button>
                ))}
