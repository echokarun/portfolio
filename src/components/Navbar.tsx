...
const socials = [
  {
    ...
    icon: (
      <svg className="size-5" fill="currentColor" viewBox="0 0 24 24" aria-label="GitHub" role="img">
        <title>GitHub</title>
  ...
  },
  {
    ...
    icon: (
      <svg className="size-5" fill="currentColor" viewBox="0 0 24 24" aria-label="LinkedIn" role="img">
      ...
      >
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {mobileOpen ? (
                <svg className="size-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="false" role="img">
